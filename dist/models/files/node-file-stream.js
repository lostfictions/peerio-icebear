 ...
 * @public
 */
let NodeFileStream = class NodeFileStream extends FileStreamAbstract {
    ...
    readInternal(size) {
        return new Promise((resolve, reject) => {
            ...
            fs.read(this.fileDescriptor, Buffer.from(buffer.buffer), 0, size, this.nextReadPos, (err, bytesRead) => {
                if (this.checkForError(err, reject)) return;
