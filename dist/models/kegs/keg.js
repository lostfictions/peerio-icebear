 ...
 */
let Keg = (_class = class Keg {
    constructor(id, type, db, plaintext = false, forceSign = false, allowEmpty = false, storeSignerData = false) {
        _initDefineProp(this, 'signatureError', _descriptor, this);

        _initDefineProp(this, 'sharedKegError', _descriptor2, this);

        _initDefineProp(this, 'id', _descriptor3, this);

        _initDefineProp(this, 'tempId', _descriptor4, this);

        _initDefineProp(this, 'version', _descriptor5, this);

        _initDefineProp(this, 'deleted', _descriptor6, this);

        _initDefineProp(this, 'loading', _descriptor7, this);

        _initDefineProp(this, 'saving', _descriptor8, this);

        _initDefineProp(this, 'dirty', _descriptor9, this);
        ...
        try {
            ...
            if (this.pendingReEncryption) {
                ...
                if (this.validatingKeg) {
                    return asPromiseMultiValue(this, 'sharedKegError', [true, false]).then(() => this.internalSave());
                }
            ...
            if (this.forceSign || !this.plaintext && this.db.id !== 'SELF') {
                signingPromise = this.signKegPayload(payload).then(signature => {
    ...
    load() {
        ...
        return socket.send('/auth/kegs/get', {
            ...
            if (ret === false) {
                return Promise.reject(new Error(`Failed to hydrate keg id ${this.id} with server data from db ${this.db ? this.db.id : 'null'}`));
            }
            return ret;
    ...
    verifyKegSignature(payload, props) {
        ...
        contact.whenLoaded(() => {
            ...
            contact.notFound ? Promise.resolve(false) : sign.verifyDetached(this.plaintext ? cryptoUtil.strToBytes(payload) : payload, signature, contact.signingPublicKey).then(r => {
                this.signatureError = !r;
            });
        });
    }
...
}, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'signatureError', [observable], {
    enumerable: true,
    initializer: function () {
        return null;
    }
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'sharedKegError', [observable], {
    enumerable: true,
    initializer: function () {
        return null;
    }
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'id', [observable], {
    enumerable: true,
    initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, 'tempId', [observable], {
    enumerable: true,
    initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, 'version', [observable], {
    enumerable: true,
    initializer: function () {
        return 0;
    }
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, 'deleted', [observable], {
    enumerable: true,
    initializer: function () {
        return false;
    }
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, 'saving', [observable], {
    enumerable: true,
    initializer: function () {
        return false;
    }
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, 'dirty', [observable], {
    enumerable: true,
    initializer: function () {
        return false;
    }
