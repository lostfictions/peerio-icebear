...
function getSystemMessageText(msg) {
    switch (msg.systemData.action) {
        case 'rename':
            return msg.systemData.newName ? t('title_chatRenamed', { name: msg.systemData.newName }) : t('title_chatNameRemoved');
        case 'purposeChange':
            return msg.systemData.newPurpose ? t('title_chatPurposeChanged', { purpose: msg.systemData.newPurpose }) : t('title_chatPurposeRemoved');
        case 'create':
